    ...
    <section className="mb-8">
      ...
      <div className="border-l-4 border-blue-500 pl-4">
        <div className="mb-4">
          ...
          <p className="font-semibold mt-2"> GPA: 3.94/4.0 | Dean&apo;s List (Fall 2023, Spring 2024, Fall 2024)</p>
          ...
          <div className="mt-2">
            ...
            <p>Data Structures & Algorithms, Software Engineering, Discrete Structures, Operating Systems, Computer Architecture, Computer Networks</p>
          </div>
        </div>
      </div>
